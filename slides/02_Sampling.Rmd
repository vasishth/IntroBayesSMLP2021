...
You can run this code (hidden) to visualize the simulated posterior distribution. See Figure \ref{fig:posteriorbivariateexample}.

```{r echo=FALSE, fig.height=3,fig.cap="\\label{fig:posteriorbivariateexample}Example of posterior distribution of a bivariate distribution."}
library(MASS)
bivar.kde<-kde2d(x,y)
