...
\begin{equation}
f(y)= \int f(y,\theta)\, d\theta = \int f(y\mid \theta) f(\theta)\, d\theta
\end{equation}
...
```{r,binomlik,echo=FALSE, message=FALSE,fig.height=4,fig.cap="\\label{fig:binomplot}Binomial likelihood function."}
library(ggplot2)
library(tidyverse)
## Likelihood
k <- 46
