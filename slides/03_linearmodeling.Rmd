...
```{r echo=FALSE,fig.height=4,message=FALSE,fig.cap="\\label{fig:m1stanplot}Posterior distributions of the parameters in model m1."}
...
```{r echo=FALSE,fig.height=4,message=FALSE,fig.cap="\\label{fig:m1traceplot}Trace plots in model m1."}
...
posterior_summary(m1brms,pars=c("b_Intercept"))
```
...
```{r lognormal,echo=FALSE,fig.height=3,fig.height=2,fig.width=3.5, fig.show='hold', message=FALSE, warning=FALSE,fig.cap="\\label{fig:logndemo}The log-normal distribution."}
mu <- 6
sigma <- 0.5
N <- 100000
...
\begin{equation}
RT_i \sim LogNormal(\alpha + presses_i \cdot \beta,\sigma)
\end{equation}
...
Daniel J. Schad, Michael Betancourt, and Shravan Vasishth. Toward a principled Bayesian workflow in cognitive science. Psychological Methods, 26(1):103--126, 2020.
